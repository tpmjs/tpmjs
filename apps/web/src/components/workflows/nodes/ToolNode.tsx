...
export function ToolNode({ data, selected }: NodeProps) {
  ...
  return (
    ...
    >
      ...
      <div className="bg-purple-500 text-white px-3 py-1.5 rounded-t-[6px] flex items-center gap-2">
      ...
      <div className="px-3 py-2">
        ...
        {nodeData.packageName && (
          <p className="text-xs text-foreground-tertiary truncate mt-0.5">{nodeData.packageName}</p>
        )}
      </div>
